...
var sequentialSchemeRegistry = (0, _core.getSequentialSchemeRegistry)();
var config = {
  /**
  ...
  controlPanelSections: [_chartControls.sections.legacyRegularTime, {
    ...
    controlSetRows: [[{
      ...
      config: {
        ...
        description: (0, _core.t)('The fields that you want to show using area chart, each element should be splited by ;')
      }
    }], [{
      name: 'area_label',
      config: {
        type: 'CheckboxControl',
        label: (0, _core.t)('Area Chart Label'),
        renderTrigger: true,
        default: false,
    ...
    controlSetRows: [[{
      ...
      config: {
        type: 'CheckboxControl',
        label: (0, _core.t)('Bar Chart Label'),
        renderTrigger: true,
        default: false,
