...
class SupersetPluginChartMixedBarArea extends _core.ChartPlugin {
  /**
  ...
  constructor() {
    var metadata = new _core.ChartMetadata({
      description: 'Superset Plugin Chart Mixed Bar Area',
      name: (0, _core.t)('Custom mixed bar and area chart'),
      thumbnail: _thumbnail.default
    });
    super({
      buildQuery: _buildQuery.default,
      controlPanel: _controlPanel.default,
      loadChart: () => Promise.resolve().then(() => _interopRequireWildcard(require('../SupersetPluginChartMixedBarArea'))),
      metadata,
